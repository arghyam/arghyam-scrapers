...
var yearTbSel     = '#ctl00_ContentPlaceHolder1_gvshow tr:gt(1)',
    yearData,
    yearList;
...
var districtTbSel   =   '#ctl00_ContentPlaceHolder1_gvDistrict tr:gt(1)',
    districtData;
...
casper.start('http://tsc.gov.in/Report/Physical/RptYearWiseCountryLevelAch.aspx?id=PHY', function() {
  ...
  this.each(yearList, function(casper, year, index)
  {
    ...
    this.then(function()
    {
      ...
      this.then(function()
      {
        write(year+'districtData_L20.csv', buffer_district);
        buffer_district = [];
      });
    ...
    this.then(function()
    {
        write(year+'stateData_L20.csv', buffer_state);
        buffer_state = [];
    });
    this.then(function()
    {
  ...
  this.then(function()
  {
    write('yearData_L20.csv', buffer_year);
    buffer_year = [];
  });
});
